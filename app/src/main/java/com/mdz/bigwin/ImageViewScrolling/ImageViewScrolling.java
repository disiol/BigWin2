package com.mdz.bigwin.ImageViewScrolling;
...
public class ImageViewScrolling extends FrameLayout {
    ...
    public int SLOT1=0,SLOT2=1,SLOT3=2,SLOT4=3,SLOT5=4,SLOT6=5;
    IEventEnd eventEnd;
    ...
    private void setImage(ImageView image_view, int value) {
        if(value == SLOT1){
            ...
            image_view.setImageResource(R.drawable.slot4);
        }else if(value == SLOT5){
            image_view.setImageResource(R.drawable.slot5);
        }else if(value == SLOT6){
            image_view.setImageResource(R.drawable.slot6);
        }
